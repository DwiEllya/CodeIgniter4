                ...
                <form action="/film/edit" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="id_genre" id="genre" class="form-control <?= isset($errors['id_genre']) ? 
                            'is-invalid ' : ''; ?>" name="id_genre">
                        ...
                        <div class="col-md-6">
                            ...
                            : ''; ?>" id="duration" name="duration" value=" <?= isset($errors['nama_film']) ? 
                            old('duration') : $semuafilm['duration']; ?>">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-2">
                                    <?php if ($semuafilm["cover"]) : ?>
                                        <img src="/assets/film/<?= $semuafilm["cover"]; ?>" width="100">
                                    <?php else : ?>
